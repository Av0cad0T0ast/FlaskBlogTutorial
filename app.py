...
# create a route to edit a pot. Load page with get or post method
...
def edit(id):
    ...
    if request.method == 'POST':
        ...
        # if no title or content, flash a error message
        if not title:
            flash("Title is required")
        elif not content:
            flash("Content is required")
...
# delete page will onl be proccessed with a POST method
